'use strict';(function(){const searchDataURL='/en.search-data.min.9fe125ff074231fa6006e1585c3fc861729d6e4687b55609bf43d0f3caaab11b.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
